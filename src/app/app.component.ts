...
@Component({
  ...
  template: `
    <nav class="navbar navbar-expand navbar-light bg-light">
      <a class="navbar-brand" routerLinkActive="active" [routerLink]="['/welcome']"
        ><img [src]="pageLogo" alt="CannaInflux" style="width:30px;height:auto;" />Cannainflux</a
      >
      <ul class="navbar-nav">
...
export class AppComponent {
  title = 'cannainflux';
  pageLogo = '../assets/cannainflux_logo.png';
